...
function airCtl($http) {
    ...
    aCtl.name = function () {
        ...
        var current_query = 'https://airport.api.aero/airport/match/' + aCtl.city + '?user_key='
    ...
    aCtl.getGoogleMap = function () {
        var current_gmap_query = 'https://maps.googleapis.com/maps/api/directions/json?origin=' + aCtl.gStreetAddressClean + ',+' + aCtl.gCity + ',+' + aCtl.gZip + '&destination=' + aCtl.airportLat + ',' + aCtl.airportLng + '&mode=driving&lnaguage=en&key='
